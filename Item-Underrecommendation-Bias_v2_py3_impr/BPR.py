...
utility.plot_performance(precision, "Precision", outputs_performance_dir, "({}) BPR".format(dataname))
utility.plot_performance(precision, "Recall", outputs_performance_dir, "({}) BPR".format(dataname))
utility.plot_performance(precision, "F1", outputs_performance_dir, "({}) BPR".format(dataname))
utility.plot_performance(precision, "NDCG", outputs_performance_dir, "({}) BPR".format(dataname))
utility.plot_performance(precision, "RSP", outputs_performance_dir, "({}) BPR".format(dataname))
utility.plot_performance(precision, "REO", outputs_performance_dir, "({}) BPR".format(dataname))
