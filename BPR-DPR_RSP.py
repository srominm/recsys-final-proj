...
outputs_dir = os.path.join('.', 'outputs', 'BPR_DRP_RSP', dataname)
...
for i in range(n):
    with tf.compat.v1.Session() as sess:
        bpr_drp_rsp = BPR_DRP_RSP(sess, args, train_df, vali_df, item_genre, genre_error_weight, 
                                  key_genre, item_genre_list, user_genre_count, outputs_dir)
        [prec_one, rec_one, f_one, ndcg_one, Rec] = bpr_drp_rsp.run()
...
utility.plot_performance(precision, "Precision", outputs_performance_dir, dataset_name=dataname, algo_name="BPR_DRP_RSP")
utility.plot_performance(recall, "Recall", outputs_performance_dir, dataset_name=dataname, algo_name="BPR_DRP_RSP")
utility.plot_performance(f1, "F1", outputs_performance_dir, dataset_name=dataname, algo_name="BPR_DRP_RSP")
utility.plot_performance(ndcg, "NDCG", outputs_performance_dir, dataset_name=dataname, algo_name="BPR_DRP_RSP")
utility.plot_performance(RSP, "RSP", outputs_performance_dir, dataset_name=dataname, algo_name="BPR_DRP_RSP")
utility.plot_performance(REO, "REO", outputs_performance_dir, dataset_name=dataname, algo_name="BPR_DRP_RSP")
